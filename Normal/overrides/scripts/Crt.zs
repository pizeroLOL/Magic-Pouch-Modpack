...
//Content Tweaker
recipes.addShaped(<contenttweaker:magic_pouch>, [
	[<contenttweaker:voidseer_eye>, <aetherworks:item_crown:*>, <contenttweaker:infinity_spring>],
	[<contenttweaker:artificial_demon>, <minecraft:rabbit_stew>, <contenttweaker:sky_orb>], 
	[<contenttweaker:composite_dragon_scale>, <contenttweaker:forbidden_fig_pie>, <contenttweaker:ultimate_sword>]
]);

Fey.addRecipe("dragon_scale", <contenttweaker:composite_dragon_scale>, [<minecraft:skull:5>, <mysticalagradditions:stuff:3>, <ore:elvenDragonstone>, <quark:enderdragon_scale>, <minecraft:dragon_egg>]);
Alchemy.add(<contenttweaker:forbidden_fig_pie>, 
[<roots:wildewheet_bread>, <thaumicwonders:panacea:1>, <naturalpledge:apple_immortality>, <thebetweenlands:forbidden_fig>, <wizardry:fairy_imbued_apple>], 
{"silver":6 to 66, "copper": 6 to 66, "lead":6 to 66, "dawnstone": 6 to 66, "iron":6 to 66});

TreeRitual.addRecipe("infinity_spring", <forbiddenmagicre:sapling_tainted>, <contenttweaker:infinity_spring>, 666, [<minecraft:dragon_breath>, <thaumicwonders:lethe_water>, <naturesaura:aura_bottle>.withTag({stored_type: "naturesaura:overworld"}), <ore:bEnderAirBottle>, <minecraft:experience_bottle>, <thebetweenlands:dentrothyst_fluid_vial>.withTag({Fluid: {FluidName: "shallowbreath", Amount: 1000}}), <naturesaura:aura_bottle>.withTag({stored_type: "naturesaura:nether"}), <naturesaura:aura_bottle>.withTag({stored_type: "naturesaura:end"})]);

RuneAltar.addRecipe(<contenttweaker:ultimate_sword>, [<bloodmagic:bound_sword:*>, <thebetweenlands:ancient_greatsword:*>, <astralsorcery:itemchargedcrystalsword:*>, <embers:tyrfing:*>, <ichoriumkit:ichorium_sword_adv:*>, <wizardry:unicorn_dagger:*>, <naturalpledge:shadowbreaker:*>, <roots:runed_sword:*>, <naturesaura:infused_iron_sword:*>], 666666);

Infusion.registerRecipe("void_eye_item", "", <contenttweaker:voidseer_eye>, 66, 
[<aspect:praecantatio>*66, <aspect:alienis>*66, <aspect:infernus>*66], <minecraft:ender_eye>, 
[<botania:thirdeye>, <embers:golems_eye>, <xat:dragons_eye>, <thebetweenlands:items_misc:52>, <naturesaura:eye>, <thaumcraft:voidseer_charm>]);

AlchemyTable.addRecipe(<contenttweaker:artificial_demon>, 
[<botania:cosmetic:13>, <botania:felpumpkin>, <thaumicperiphery:malignant_heart>, <wizardry:devil_dust>, <forbiddenmagicre:diabolist_fork>, <thaumcraft:flesh_block>], 66666,666,5);
...
Crucible.registerRecipe("ae2", "", <appliedenergistics2:material:2> * 2, <appliedenergistics2:material:1>, [<aspect:perditio>*5, <aspect:vitreus>*5]);
...
recipes.addShaped(<tinkersaddons:modifier_item:4>, [[null, null, null],[<tconstruct:large_plate>.withTag({Material: "fierymetal"}).onlyWithTag({Material: "fierymetal"}), <ore:blockAether>, <tconstruct:large_plate>.withTag({Material: "steeleaf"}).onlyWithTag({Material: "steeleaf"})], [<tconstruct:large_plate>.withTag({Material: "dawnstone"}).onlyWithTag({Material: "dawnstone"}), <tconstruct:large_plate>.withTag({Material: "pigiron"}).onlyWithTag({Material: "pigiron"}), <tconstruct:large_plate>.withTag({Material: "octine"}).onlyWithTag({Material: "octine"})]]);
